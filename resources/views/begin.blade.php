...
<div class="container">
        <div class="row">
            ...
            {{ Form::open(array('url' => '/start')) }}
                ...
                <div class="form-group{{ $errors->has('tester_name') ? ' has-error' : '' }}">
                    {!! Form::Label('tester_name', 'Username') !!}
                    {!! Form::text('tester_name', null, ['class' => 'form-control', 'placeholder' => 'Username']) !!}
                    @if($errors->has('tester_name'))
                        <span class="help-block">{{ $errors->first('tester_name') }}</span>
                    @endif
                </div>
